...
Install_PHP72() {
  ...
  sed -i "s@^;curl.cainfo.*@curl.cainfo = ${openssl_install_dir}/ssl/cert.pem@" ${php_install_dir}/etc/php.ini
  sed -i "s@^;openssl.cafile.*@openssl.cafile = ${openssl_install_dir}/ssl/cert.pem@" ${php_install_dir}/etc/php.ini
