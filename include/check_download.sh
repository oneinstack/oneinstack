    ...
    case "${db_option}" in
      1)
        ...
        if [ "${OUTIP_STATE}"x == "China"x ]; then
          ...
          DOWN_ADDR_MYSQL_BK=https://mirrors.huaweicloud.com/mysql/Downloads/MySQL-8.0
      ...
      2)
        ...
        if [ "${OUTIP_STATE}"x == "China"x ]; then
          ...
          DOWN_ADDR_MYSQL_BK=https://mirrors.huaweicloud.com/mysql/Downloads/MySQL-5.7
      ...
      3)
        ...
        if [ "${OUTIP_STATE}"x == "China"x ]; then
          ...
          DOWN_ADDR_MYSQL_BK2=https://mirrors.huaweicloud.com/mysql/Downloads/MySQL-5.6
        else
      ...
      4)
        ...
        if [ "${OUTIP_STATE}"x == "China"x ]; then
          ...
          DOWN_ADDR_MYSQL_BK2=https://mirrors.huaweicloud.com/mysql/Downloads/MySQL-5.5
        else
